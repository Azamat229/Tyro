...
public class TestingAapter extends RecyclerView.Adapter<TestingAapter.ViewHolder> {
    private Context context;
    private ArrayList<Catgory> questionsModalArrayList;
    private ArrayList<Faqcatgories> questionsModalArrayList1;
    // creating a constructor class.
    public TestingAapter(Context context, ArrayList<Catgory> questionsModalArrayList, ArrayList<Faqcatgories> faqcatgories1) {
    ...
    @NonNull
    @Override
    public TestingAapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // passing our layout file for displaying our card item
        return new TestingAapter.ViewHolder(LayoutInflater.from(context).inflate(R.layout.activity_faqlist, parent, false));

    }

    @Override
    public void onBindViewHolder(@NonNull TestingAapter.ViewHolder holder, int position)
    {
