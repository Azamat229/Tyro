...
public class Conversation {
    ...
    String instruct_language, instruct_id, instruct_firstname, instruct_img, instruct_rate, instruct_distance, message,
            read_status;

    public Conversation(String instruct_language, String instruct_id, String instruct_firstname, String instruct_img, String instruct_rate, String instruct_distance, String message,
                        String read_status) {
